class ZCL_T_TRYCATCH_INSIDE_LOOP_EX definition
  public
  final
  create public .
...
CLASS ZCL_T_TRYCATCH_INSIDE_LOOP_EX IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    test_name = |[LOOP TRY ->inside<-  CATCH ENDLOOP]  exception_thrown|.
